    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('PUBLIC', 'public'), ('PRIVATE', 'private')], default='PUBLIC', max_length=9)),
                ('published', models.DateTimeField(default=django.utils.timezone.now)),
                ('comment', models.URLField(default='', max_length=256)),
                ('categorie', models.CharField(choices=[('WEB', 'web'), ('TUTORIAL', 'tutorial')], default='WEB', max_length=9)),
