...
class ProfileCard extends React.Component {
  ...
  handleEditProfile = async () => {
    ...
    const doc = await axios.patch(`/api/authors/${id}/`, { email, github, bio, password });
  ...
  handleAddFriend = async () => {
    ...
    const doc = await axios.post("/api/friendrequest/", {from_user: currentUser.id, to_user: id});
    if (doc.data) {
  ...
  handleDeleteFriend = async () => {
    ...
    const doc = await axios.patch("/api/friendrequest/delete", {from_user: currentUser.id, to_user: id});
    if (doc.data) {
      window.alert(doc.data);
    }
  }
